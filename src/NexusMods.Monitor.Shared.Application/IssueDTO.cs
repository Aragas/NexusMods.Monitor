...
{
    public sealed record IssueDTO(uint Id, uint NexusModsGameId, uint NexusModsModId, string Title, string Url, string ModVersion, IssueStatusDTO Status, IssuePriorityDTO Priority, bool IsPrivate, bool IsClosed, DateTimeOffset TimeOfLastPost, IssueContentDTO? Content, IReadOnlyCollection<IssueReplyDTO> Replies);
