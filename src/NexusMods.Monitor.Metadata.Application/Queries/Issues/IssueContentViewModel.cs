...
{
    public sealed record IssueContentViewModel(uint Id, string Author, string AuthorUrl, string AvatarUrl, string Content, Instant Time)
    {
        public static IssueContentViewModel FromElement(IElement element)
        {
            ...
            return new IssueContentViewModel(RecordUtils.Default<IssueContentViewModel>())
            {
