...
namespace NexusMods.Monitor.Scraper.Application.Commands.Issues
{
    // TODO:
    [DataContract]
    public sealed record IssueAddNewCommand : IRequest<bool>
    {
        [DataMember]
        ...
        public IssueAddNewCommand(NexusModsIssueRootViewModel nexusModsIssueRoot, IssueStatusEnumeration issueStatus, IssuePriorityEnumeration issuePriority) : this()
        {
