...
namespace NexusMods.Monitor.Scraper.Application.Queries.NexusModsIssues
{
    ...
    {
        public static NexusModsIssueReplyViewModel FromElement(IElement element)
        {
            ...
            return new NexusModsIssueReplyViewModel(RecordUtils.Default<NexusModsIssueReplyViewModel>())
            {
