...
using System.Text;
using NexusMods.Monitor.Scraper.Infrastructure.ComposableAsync.Awaitable;
using NexusMods.Monitor.Scraper.Infrastructure.ComposableAsync.DelegatingHandler;
using NexusMods.Monitor.Scraper.Infrastructure.ComposableAsync.Dispatcher;

namespace NexusMods.Monitor.Scraper.Infrastructure.ComposableAsync
{
    /// <summary>
    ...
    public static class DispatcherExtension
    {
        ...
        /// <param name="dispatcher"></param>
        /// <returns></returns>
        public static System.Net.Http.DelegatingHandler AsDelegatingHandler(this IDispatcher dispatcher)
        {
