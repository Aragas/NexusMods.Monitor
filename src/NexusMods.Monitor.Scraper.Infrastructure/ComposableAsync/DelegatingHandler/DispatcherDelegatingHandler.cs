...
namespace NexusMods.Monitor.Scraper.Infrastructure.ComposableAsync.DelegatingHandler
{
    /// <summary>
    /// A <see cref="DelegatingHandler"/> implementation based on <see cref="IDispatcher"/>
    /// </summary>
    internal class DispatcherDelegatingHandler : System.Net.Http.DelegatingHandler
    {
